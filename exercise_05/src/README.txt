...
(MST, squared-weight MST/SPT, the Kruskal=Prim counterexample, flow values,
Euler trace, the unique perfect matching, insertion-sort counts for n <= 7,
lamp costs for all inputs with n <= 8).
